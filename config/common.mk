...
# Set all versions
FLEX_VERSION := FlexOS-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(FLEX_BUILD_TYPE)$(FLEX_POSTFIX)
FLEX_MOD_VERSION := FlexOS-$(flex_BUILD)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)-$(FLEX_BUILD_TYPE)$(FLEX_POSTFIX)
